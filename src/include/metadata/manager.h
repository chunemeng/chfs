...
public:
   ...
   */
    ...
    auto allocate_inode(InodeType type, block_id_t bid, std::vector<std::shared_ptr<BlockOperation>> &ops, bool &is_err) -> ChfsResult<inode_id_t>;
   ...
   */
    ...
    auto set_table(inode_id_t idx, block_id_t bid, std::vector<std::shared_ptr<BlockOperation>> &ops, bool &is_err) -> ChfsNullResult;
